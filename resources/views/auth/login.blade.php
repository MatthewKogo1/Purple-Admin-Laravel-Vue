            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <img src="../../../assets/images/pos2.jpg" class="mx-auto d-block">
                </div>
                ...
                <form class="pt-3"  method="POST" action="{{ route('login') }}" autocomplete="off">
                  ...
                  <div class="form-group">
                    <input type="email" class="form-control form-control-lg  @error('email') is-invalid @enderror" name="email"  id="exampleInputEmail1" placeholder="E-mail" >
                    @error('email')
